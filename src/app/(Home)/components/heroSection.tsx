...
export default function HeroSection({ searchBoxRef }: HeroSectionProps) {
  ...
  return (
    <section className="relative w-full bg-[#F8F9FA] overflow-hidden">
      {/* On first cycle/first slide, render nothing until image is loaded, then render both image and text together */}
      {(!firstCycleDone && currentIndex === 0 && !firstImageLoaded) ? null : (
        <>
