    ...
    <section className="relative w-full bg-[#F8F9FA] overflow-hidden">
      ...
      <div className="relative w-full aspect-[16/9] sm:aspect-[21/9] lg:aspect-[24/9] max-h-[90vh]">
        <Image
          ...
          onLoadingComplete={() => {
            if (currentIndex === 0 && !firstImageLoaded) setFirstImageLoaded(true);
          }}
        />
      ...
      <div
        className={`absolute inset-0 z-20 flex flex-col items-center justify-start pt-8 sm:pt-16 md:pt-24 px-4 py-12 sm:py-16 md:py-20 pb-24 sm:pb-32 md:pb-40 transition-opacity duration-300 ${firstImageLoaded ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}
